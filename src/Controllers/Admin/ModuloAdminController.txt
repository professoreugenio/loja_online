...
final class ModuloAdminController
{
    ...
    */
    ...
    public function perfil(): void
    {
        ...
        $sucesso =
            $_SESSION['admin_perfil_sucesso']
            ?? null;

        $erro =
            $_SESSION['admin_perfil_erro']
            ?? null;
    ...
    public function perfilCadastrar(): void
    {
        /*
    |--------------------------------------------------------------------------
    | SEGURANÇA
    ...
    | O Controller também deve bloquear Operador.
    */
        SessaoAdmin::exigirMaster();
    ...
    public function adminAtualizar(): void
    {
        /*
    |--------------------------------------------------------------------------
    | 1. Somente MASTER pode alterar outro administrador
    |--------------------------------------------------------------------------
    */
        SessaoAdmin::exigirMaster();
    ...
    */
        if (
            ...
            $erros[] =
                ...
                . 'utilizado por outro administrador.';
        }
    ...
    */
        try {
            ...
            /*
        |--------------------------------------------------------------------------
        | Se estiver alterando a própria conta
        |--------------------------------------------------------------------------
        */
            if (
                (int) $adminId
    ...
    */
    ...
    private function redirecionarPerfil(): never
    {
        header(
            'Location: '
                . $this->baseUrl()
...
*/
    ...
    private function usuarioAdminRepository(): UsuarioAdminRepository
    {
        $raizProjeto =
            dirname(__DIR__, 3);
