                ...
                <section class="mb-4">
                    <div class="row g-3">
                        <div class="col-12 col-sm-6 col-xl-3">
                            <h1 class="h3 fw-bold mb-1">cliente view</h1>
                            Exibir os dados do cliente, endereços cadastrados, pedidos realizados, histórico de pagamentos e outras informações relevantes para o gerenciamento do cliente na loja online.
                        </div>
